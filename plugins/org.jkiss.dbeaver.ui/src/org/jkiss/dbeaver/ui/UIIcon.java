...
public class UIIcon {
    ...
    public static final DBIcon LOADING0 = new DBIcon("loading0", "animation/loading00.png"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public static final DBIcon CLEAN = new DBIcon("clean", "misc/clean.png"); //$NON-NLS-1$//
    // $NON-NLS-2$
